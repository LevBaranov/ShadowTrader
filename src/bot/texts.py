...
welcome_guest = """Необходимо настроить связку счёт брокера индекс МБ. Выберете счёт который будет привязан к IMOEX
...
success = "Успешно:\n"
errors = "Ошибки:\n"
change_scheduler = "Выберите как часто выполнять синхронизацию:"
